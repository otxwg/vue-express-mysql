<template>
  <div>
    <el-form-item :label="'背景颜色(全局)'">
      <el-color-picker v-model="optionModel.commonBg"></el-color-picker>
    </el-form-item>
    <el-form-item :label="'奇数td颜色'">
      <el-color-picker v-model="optionModel.oddBg"></el-color-picker>
    </el-form-item>
    <el-form-item :label="'偶数td颜色'">
      <el-color-picker v-model="optionModel.evenBg"></el-color-picker>
    </el-form-item>
    <el-form-item :label="'字体颜色(全局)'">
      <el-color-picker v-model="optionModel.commonColor"></el-color-picker>
    </el-form-item>
    <el-form-item :label="'字体大小(全局)'">
    ...
    <el-form-item :label="'表格高度'">
      <el-input type="number" v-model="optionModel.cellHeight">
        <template slot="suffix">
          px
        </template>
      </el-input>
    </el-form-item>
    <el-form-item :label="'表格样式修改'">
      <el-button type="primary" size="small" @click="addCss">编写css1</el-button>
    </el-form-item>
    <gd-dialog :title="'表格样式修改'" size="small" :z-index="2001" :closed.sync="showDialog" :append-to-body="true" draggable :maximized.sync="maximized" width="800px">
