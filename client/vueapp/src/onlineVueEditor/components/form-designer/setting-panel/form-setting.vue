<template>
  <div>
    <el-form :model="formConfig" size="mini" label-position="left" label-width="120px" class="setting-form" @submit.native.prevent>
      <el-collapse v-model="formActiveCollapseNames" class="setting-collapse" style="border-bottom: none !important">
    ...
    <gd-dialog
      ...
      :closed.sync="showEditFormCssDialogFlag"
      class="small-padding-dialog"
      :maximized.sync="maximized"
      draggable
      maximizable
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="saveFormCss"> {{ i18nt('designer.hint.confirm') }}12</el-button>
      </div>
    </gd-dialog>

    <gd-dialog
      :title="i18nt('designer.setting.globalFunctions')"
      :closed.sync="showEditFunctionsDialogFlag"
      class="small-padding-dialog"
      :maximized.sync="maximized"
      draggable
      maximizable
