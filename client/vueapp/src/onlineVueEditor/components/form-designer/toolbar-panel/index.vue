<template>
  <div class="toolbar-container">
    <div class="right-toolbar">
      <el-button size="small" class="right-toolbar-btn" @click="clearFormWidget"> <i class="el-icon-delete" />{{ i18nt('designer.toolbar.clear') }}</el-button>
      <el-button size="small" class="right-toolbar-btn" @click="previewForm"> <i style="font-size: 12px" class="iconfont-erp iconguanlian" />关联实体</el-button>
      <el-button size="small" class="right-toolbar-btn" @click="generateSFC">
        <svg-icon icon-class="code" icon-type="svg"></svg-icon>
        生成代码
      </el-button>
      <el-button size="small" class="right-toolbar-btn" type="" @click="saveFormModule"> <i class="iconfont-wfmng wfmng-baocun" style="font-size: 16px"></i>保存表单模板</el-button>
      <el-button size="small" class="right-toolbar-btn" type="" @click="setMenu"><i class="iconfont-erp iconmobanguanli" style="font-size: 12px"></i>生成菜单</el-button>
      <el-button size="small" type="success" @click="previewForm"> <i class="el-icon-view" />{{ i18nt('designer.toolbar.preview') }}</el-button>
      <el-button size="small" type="primary" @click="generateSave"><i class="iconfont-erp iconfabutijiao" style="font-size: 12px"></i> 发布</el-button>
    ...
    <gd-dialog
      ...
      class="small-padding-dialog"
    >
      <code-editor :min-lines="500" :max-lines="1000" :mode="'html'" :readonly="true" v-model="sfcCode" :user-worker="false"></code-editor>
      <div slot="footer" class="dialog-footer">
