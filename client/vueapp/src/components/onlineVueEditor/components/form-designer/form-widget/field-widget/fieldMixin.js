  ...
  methods: {
    ...
    initFieldModel() {
      ...
      if (!!this.subFormItemFlag && !this.designState) {
        ...
        if (
          (subFormData === undefined || subFormData[this.subFormRowIndex] === undefined || subFormData[this.subFormRowIndex][this.field.options.name] === undefined) &&
    ...
    buildFieldRules() {
      ...
      if (!!this.field.options.required) {
        this.rules.push({
          ...
          trigger: ['blur', 'change'],
          message:
            this.field.options['validationHint'] && this.field.options['validationHint'] !== '' ? this.field.options['validationHint'] : this.i18nt('render.hint.fieldRequired')
        })
      }
