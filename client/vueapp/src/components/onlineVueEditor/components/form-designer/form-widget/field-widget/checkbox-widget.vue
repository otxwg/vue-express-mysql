<template>
  ...
  >
    <el-checkbox-group ref="fieldEditor" v-model="fieldModel" :disabled="field.options.disabled" :size="field.options.size" @change="handleChangeEvent">
      <template v-if="!!field.options.buttonStyle">
        <el-checkbox-button
          ...
          >{{ item[selectProps.label] }}</el-checkbox-button
        >
      </template>
      <template v-else>
        <el-checkbox
          ...
          :border="field.options.border"
          :style="{ display: field.options.displayStyle }"
          >{{ item[selectProps.label] }}</el-checkbox
        >
      </template>
    </el-checkbox-group>
  </form-item-wrapper>
