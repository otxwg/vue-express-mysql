  ...
  >
    ...
    >
      ...
      <div slot="file" slot-scope="{ file }" class="upload-file-list">
        ...
        <a :href="file.url" download=""> <i class="el-icon-download file-action" title="i18nt('render.hint.downloadFile')"></i></a>
        <i class="el-icon-delete file-action" title="i18nt('render.hint.removeFile')" v-if="!field.options.disabled" @click="removeUploadFile(file.name)"></i>
      </div>
    </el-upload>
  </form-item-wrapper>
</template>
