export default {
  ...
  designer: {
    ...
    hint: {
      ...
      loadFormTemplateHint: '是否加载这个模板？加载后会覆盖设计器当前表单。',
    ...
    setting: {
      ...
      circle: '圆形按钮',
      icon: '图标',
      bodyBackground: '内容背景色',
      headerBackground: '头部背景色',
      showSearchFolded: '简洁搜索',
      optionsSetting: '选项设置',
      addOption: '增加选项',
      importOptions: '导入选项',
      resetDefault: '重设选中项',
